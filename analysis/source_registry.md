...
|---|---|---|---|---|---|---|---|
| SRC-DOM-001 | Domande IUM.pdf | domande note | 2020-2021 | Analizzato | Media-bassa | [[reports/07_domande_ium]] | Domande note d’esame validate contro la KB consolidata; alcune risposte originali erano incomplete o potenzialmente errate. |
